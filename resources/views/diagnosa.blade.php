...
<section class="section doctor-single" style="margin-top:-50px;">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-6">
				<div class="doctor-details mt-4 mt-lg-0">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <p style="text-align:justify;">{{ $diagnosa->penyakit->definisi or 'Belum ada penjelasan lengkap mengenai penyakit ini.' }} {{ $diagnosa->penyakit->definisi }} </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-9">
                                            <p style="text-align:justify;">{{ $diagnosa->penyakit->penyebab }}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-9">
                                            <p style="text-align:justify;">{{ $diagnosa->penyakit->solusis->nama_solusi }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
					...
					<a href="{{url('/home')}}" class="btn btn-success btn-round-full mt-3" style="marin-top:20px;">Selesai <i class="icofont-simple-right ml-2  "></i></a>
